...
| `web/` | Next.js 16.3.6, React 19.2, Tailwind v4, Vercel | One page at `/`: hero, product, evidence, proof. Wallet connect. Builds order and cancel transactions for the user to sign. |
